...
const KEYWORD_IMAGES = {
  ...
  stanley: "https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=600&q=80",
  "stanley cup": "https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=600&q=80",
  "watch party": "https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=600&q=80",
  hurricanes: "https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=600&q=80",
  ...
  disco: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80",
  phillies: "https://images.unsplash.com/flagged/photo-1579277167836-cca446543e2d?w=600&q=80",
  baseball: "https://images.unsplash.com/flagged/photo-1579277167836-cca446543e2d?w=600&q=80",
  mets: "https://images.unsplash.com/flagged/photo-1579277167836-cca446543e2d?w=600&q=80",
        ...
        <div style={styles.infoGrid}>
          ...
          {event.venue && (
            <div style={styles.infoItem}>
              ...
              {event.url && (
                <a href={event.source === "ticketmaster" ? "https://ticketmaster.evyy.net/c/7286516/264167/4272?u=" + encodeURIComponent(event.url) : event.url} target="_blank" rel="noopener noreferrer" style={{fontSize: "0.8rem", color: "var(--brick)", marginTop: 2, textDecoration: "underline", display: "block"}}>
                  {event.id?.startsWith("tm-") ? "Get Tickets" : event.url.replace(/^https?:\/\//, "").replace(/\/$/, "").split("?")[0]}
                </a>
              )}
            </div>
          )}
