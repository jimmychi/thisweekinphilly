          ...
          {filtered.map(h => (
            <div key={h.id} style={styles.card}>
              <div style={styles.left}>
                ...
                {h.address && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(h.name + " " + h.address)}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: "0.8rem", color: "var(--brick)", textDecoration: "underline", fontFamily: "var(--font-body)", display: "inline-block", marginBottom: 4 }}>Get Directions</a>}
