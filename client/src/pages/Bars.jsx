...
const styles = {
  ...
  filters: { background: "var(--warm-white)", borderBottom: "1px solid var(--stone)", padding: "12px 16px", display: "flex", gap: 6, flexWrap: "nowrap", overflowX: "auto", WebkitOverflowScrolling: "touch", position: "sticky", top: 68, zIndex: 90, backdropFilter: "blur(8px)" },
